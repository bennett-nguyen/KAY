...
class Controller:
    ...
    def update_view(self):
        ...
        # collided_node[1]: return the queried node's ID if mouse does collide with that node
        collided_node: tuple[bool, Node] = self.view.mouse_collide_node(self.model.st.root) 
