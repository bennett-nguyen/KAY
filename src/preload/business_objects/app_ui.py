...
from src.preload.system.app_type import VisibilityField, HexStrFormat
...
class MessageTextBoxUI:
    ...
    def generate_text(self, text: str, color: HexStrFormat, pixel_size: int, face: str = "CascadiaCode") -> str:
